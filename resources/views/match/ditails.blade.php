...
@section('content')
    ...
    <div class="matches_container">
        <span class="table_title">Players of the match:{{ $playersmatch->team1 }} VS {{ $playersmatch->team2 }}</span>
        ...
        <form class="add_form" method="POST" action="{{ url('match/addMatchDitails/' . $playersmatch->id) }}">
            @csrf
